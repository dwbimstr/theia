...
- [ai-chat] removed `FileValidationState.INVALID_SECONDARY` enum value as all workspace roots are now treated equally with multi-root support [#PENDING](https://github.com/eclipse-theia/theia/pull/PENDING)
...
- [ai-ide] removed deprecated `WorkspaceFunctionScope.getWorkspaceRoot()` and `WorkspaceFunctionScope.isInPrimaryWorkspace()` methods in favor of multi-root equivalents [#PENDING](https://github.com/eclipse-theia/theia/pull/PENDING)
